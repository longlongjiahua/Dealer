...
import yong.dealer.login.library.DatabaseHandler;
import yong.dealer.login.library.UserFunctions;
 ...
 **/
        ...
        UserFunctions userFunction = new UserFunctions();
            Log.i(TAG,fname+lname + email +uname +password);
